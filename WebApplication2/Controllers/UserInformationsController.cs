...
namespace WebApplication2.Controllers
{
    public class UserInformationsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,UserName,First_Name,Last_Name,Occupation,Mobile_Number")] UserInformation userInformation)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,UserName,First_Name,Last_Name,Occupation,Mobile_Number")] UserInformation userInformation)
        {
            if (ModelState.IsValid)
            {
